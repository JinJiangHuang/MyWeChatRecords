...
class ExporterBase:
    ...
    def __init__(self, contact, type_=DOCX, message_types={}, time_range=None,
                 messages=None, index=0, parent=None, on_export_finish=None):
        ...
        self.origin_path = os.path.join(os.getcwd(), GlobalConfigs().path_export_dir, f"{self.contact.get_uniquid_name()}")
