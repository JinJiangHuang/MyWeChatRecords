...
class TxtExporter(ExporterBase):
    # def __init__(self, contact, type_=ExporterBase.DOCX, message_types={}, time_range=None, messages=None, index=0,
    #              parent=None):
    #     super().__init__(contact, type_, message_types, time_range, messages, index, parent)
