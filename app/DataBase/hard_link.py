...
image_db_path = os.path.join(GlobalConfigs().path_database_dir, "HardLinkImage.db")
video_db_path = os.path.join(GlobalConfigs().path_database_dir, "HardLinkVideo.db")
