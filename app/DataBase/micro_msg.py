...
def is_database_exist():
    ...
    db_path = os.path.join(config.path_database_dir, "MicroMsg.db")
    ...
    def init_database(self):
        ...
        if not self.open_flag:
            if os.path.exists(db_path):
                ...
                print("初始化数据库失败，db_path", db_path)
...
if __name__ == '__main__':
    ...
    s = {'wxid_vtz9jk9ulzjt22', 'wxid_zu9l4wxdv1pa22', 'wxid_0o18ef858vnu22', 'wxid_8piw6sb4hvfm22',
         'wxid_e7ypfycxpnu322', 'wxid_oxmg02c8kwxu22', 'wxid_7pp2fblq7hkq22', 'wxid_h1n9niofgyci22'}
